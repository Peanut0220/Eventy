...
namespace Assignment
{
    public partial class userEvent : System.Web.UI.Page
    {
        ...
        private void BindRepeater()
        {
            ...
            {
                Response.Write("<script> alert('No record found'); window.location.replace(\"userEvent.aspx\");</script>");
        ...
        {
            Response.Redirect("~/userEvent.aspx?search=" + TextBox1.Text);
        }

        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/userEvent.aspx?filter1=" + DropDownList1.SelectedValue + "&filter2=" + TextBox3.Text + "&filter3=" + TextBox2.Text);
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/userEvent.aspx");
        }
    }
}