<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="userEvent.aspx.cs" Inherits="Assignment.userEvent" %>
...
<tr class="buttonRows">
    <td>
        <asp:Button CssClass="btnViewDetails" ID="Button1" runat="server" Text="Buy for Pass" OnClick="Button1_Click" PostBackUrl="~/memberLogin.aspx" />
    </td>
</tr>
                                <%}
...
<tr class="buttonRows">
    <td>
        <asp:Button CssClass="btnViewDetails false" ID="Button2" runat="server" Text="Buy for Pass" OnClick="Button1_Click" Enabled="false" PostBackUrl="~/memberLogin.aspx" />
    </td>
</tr>
                                <%}
                                %>   
