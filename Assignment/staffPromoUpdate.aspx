<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="staffPromoUpdate.aspx.cs" Inherits="Assignment.staffPromoUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div cssclass="content">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [PromoCode] WHERE ([codeID] = @codeID)">
            <SelectParameters>
                <asp:QueryStringParameter Name="codeID" QueryStringField="codeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
            ...
            <ItemTemplate>
                <tr>
                    <th colspan="2" class="auto-style3">
                        ...
                        <asp:Label CssClass="staffTitle" ID="lblStaffTitle" runat="server" Text="Promo Update Form"></asp:Label>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label CssClass="label" ID="Label1" runat="server" Style="display: none;" Text='<%#Eval("codeID") %>'></asp:Label>

                    </td>
                    <td>
                        <asp:TextBox CssClass="input" ID="txtName" runat="server" Text='<%#Eval("codeName") %>'></asp:TextBox>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtName" ErrorMessage="Promo Code only can accept 3-12 character" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9'@&#.\s]{3,12}$" Text="*"></asp:RegularExpressionValidator>
                        ...
                        <asp:Label CssClass="label" ID="Label2" runat="server" Style="display: none;" Text='<%#Eval("codeName") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="input" ID="txtDiscount" runat="server" Text='<%# (Convert.ToDecimal(Eval("discountRate")) * 100).ToString("0.##") %>'></asp:TextBox>
                        %
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDiscount" ErrorMessage="Discount Rate cannot be empty" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtDiscount" ErrorMessage="Rate only contains 1-100" Type="Integer" MaximumValue="100" MinimumValue="1" ForeColor="Red" Text="*"></asp:RangeValidator>
                ...
                <tr>
                    <td colspan="2">
                        <br />
                        <asp:Button CssClass="btnAdd" ID="btnStaffAdd" runat="server" Text="Update" OnClick="btnEventUpdate_Click" />
                        <br />
